---
name: handoff-corto
description: "Create a compact app session handoff to start a fresh chat with minimal tokens. Use for compactar contexto, resumir sesion, cerrar chat y continuar mobile."
argument-hint: "Indica el objetivo de app que quieres continuar"
user-invocable: true
---
# Handoff Corto
